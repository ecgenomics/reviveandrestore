#!/bin/bash -ue
/Users/fabio/newcloud/reviveandrestore/mapping.capture/software/samtools-1.20/samtools sort -T test_R -o test_R_rmdups.sorted.bam test_R_rmdups.bam; 	/Users/fabio/newcloud/reviveandrestore/mapping.capture/software/samtools-1.20/samtools index test_R_rmdups.bam;
